            ...
            <div className="projects_container">
                ...
                <div className="projects_list">
                    <div className="project_card project_left">
                        <h3 className="project_title mobile">Pacuco</h3>
                        ...
                        <div className="project_info project_left_info">
                            <h3 className="project_title desktop">Pacuco</h3>
                            <p className="project_description">Ecommerce desarrollado con React, Node.js, Express.js, MongoDB. Pensado principalmente para mobile.</p>
                            <p className="project_description">La idea comenzo para poder digitalizar un emprendimiento familiar, y que la venta de los productos se realice de manera mas automatica. </p>
                    ...
                    <div className="project_card project_right">
                        <h3 className="project_title mobile">Torneos Atletismo</h3>
                        ...
                        <div className="project_info project_right_info">
                            <h3 className="project_title desktop">Torneos Atletismo</h3>
                            <p className="project_description">Pagina web para la carga de resultados de torneos de Atletismo desarrollado con React, Node.js, Express.js, MongoDB. Pensado principalmente para mobile.</p>
                            <p className="project_description">La idea es mejorar la experiencia de los atletas y aficionados a la hora de ver los resultados de los torneos.</p>
                            <div className='project_links'>
                    ...
                    <div className="project_card project_left">
                        <h3 className="project_title mobile">Space Survival</h3>
                        ...
                        <div className="project_info project_left_info">
                            <h3 className="project_title desktop">Space Survival</h3>
                            <p className="project_description">Juego desarrollado para una materia de la Universidad.</p>
                            <p className="project_description">Se desarrollo con Python, mas especificamente con la libreria pygame. Se uso SQLite para persistencia de datos y manejo de estadisticas.</p>
                            <div className='project_links'>
